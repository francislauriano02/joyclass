...
// Exemplo de como acessar os elementos do array e seus atributos:
arrayDeVeiculos.forEach((veiculo, index) => {
    if (veiculo instanceof Carro) {
        console.log(`\nVeículo ${index + 1} (CARRO) - Modelo: ${veiculo.getModelo()}, Marca: ${veiculo.getMarca()}, 
        Cor: ${veiculo.getCor()}, Número de Rodas: ${veiculo.getNumeroRodas()}, Número de Portas: ${veiculo.getNumeroDePortas()}`);
    } else if (veiculo instanceof Moto) {
        console.log(`\nVeículo ${index + 1} (MOTO) - Modelo: ${veiculo.getModelo()}, Marca: ${veiculo.getMarca()}, 
        Cor: ${veiculo.getCor()}, Número de Rodas: ${veiculo.getNumeroRodas()}, Cilindrada: ${veiculo.getCilindrada()}`);
    }
});
